-- Phase 39.4A: allow the existing atomic table reallocation path to target
-- a valid flat merged operational parent as well as a physical table.
...
begin
  ...
  if v_previous_table.id is null
     ...
     or (
       (v_previous_table.is_physical or v_previous_is_merged)
