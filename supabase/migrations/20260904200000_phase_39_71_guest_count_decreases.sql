-- Phase 39.71: allow financially neutral guest-count decreases for eligible
-- bookings even when the performance is sold out or inactive. Increases keep
-- the existing active-show and authoritative pricing protections.
...
begin
  ...
  if p_guest_count > v_booking.guest_count and v_show.status::text <> 'active' then
